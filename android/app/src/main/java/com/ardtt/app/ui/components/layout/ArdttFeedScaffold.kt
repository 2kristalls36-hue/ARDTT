 ...
 *
 * The title sits in [ArdttScrollChrome]; feed content scrolls underneath.
 * Passing [stickyContent] pins full-width actions above the tab pill
 * (primary CTA or a bottom stack of destination rows).
 */
@Composable
