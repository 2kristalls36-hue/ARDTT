...
class AppUpdateNotificationReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_DOWNLOAD = "com.ardtt.app.action.UPDATE_DOWNLOAD"
        const val ACTION_CANCEL_DOWNLOAD = "com.ardtt.app.action.UPDATE_CANCEL_DOWNLOAD"
        const val ACTION_INSTALL_UPDATE = "com.ardtt.app.action.UPDATE_INSTALL"
    }
}
