...
object ArdttBottomChrome {
    /** Matches floating [ArdttNavigationBar] overlay height. */
        ...
        val feed: @Composable () -> Unit = {
            Column(
                modifier = Modifier
                    ...
                    .padding(bottom = ArdttBottomChrome.scrollContentPadding()),
...
fun EdgeFeedColumn(
    ...
    val bottomPad = scrollBottomPadding ?: (ArdttBottomChrome.navigationReserve() + bottomExtra)
