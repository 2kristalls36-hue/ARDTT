 ...
 * already bind to the cell. Folding that round as Wi‑Fi makes
 * [RestrictionScore.sample] Ignore (score 0) and Auto starts Direct.
 */
 ...
 * on Wi‑Fi→LTE; that is not a different physical network for idle-stash.
 */
