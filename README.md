...
> [!NOTE]
> Клиент **0.5.248** (`versionCode` 266), пакет `com.ardtt.app`. Серверный стек **1.0.38** (`DEPLOY_VERSION`, каталог `/opt/ardtt`). Канонический источник стека — этот репозиторий, не `assets/` APK.
>
