...
> [!NOTE]
> Клиент **0.5.218** (`versionCode` 236), пакет `com.ardtt.app`. Серверный стек **1.0.29** (`DEPLOY_VERSION`, каталог `/opt/ardtt`).
>
...
| Документ | Содержание |
|----------|------------|
| [CHANGELOG.md](CHANGELOG.md) | Линейка 0.5.218 / стек 1.0.29 |
