...
> [!NOTE]
> Клиент **0.5.246** (`versionCode` 264), пакет `com.ardtt.app`. Серверный стек **1.0.37** (`DEPLOY_VERSION`, каталог `/opt/ardtt`). Канонический источник стека — этот репозиторий, не `assets/` APK.
>
...
| Откуда стек | GitHub Releases `ardtt-stack-1.0.37.tar.gz` или архив тега `v0.5.246` — **не** APK |
...
| Документ | Содержание |
|----------|------------|
| [CHANGELOG.md](CHANGELOG.md) | Линейка 0.5.246 / стек 1.0.37 |
