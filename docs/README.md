...
Обзор продукта, состав репозитория и текущие версии — в корневом [README.md](../README.md) (клиент и VPS-стек в одном дереве). Заметки линейки 0.5.250 — [CHANGELOG.md](../CHANGELOG.md).
...
| [DEPLOY.md](DEPLOY.md) | Стек **1.0.39**: из приложения (GitHub) или `git clone` / `ARDTT_GIT_REF` |
...
| [android/README.md](../android/README.md) | Сборка клиента 0.5.250, keystore, GitHub Releases |
