...
Обзор продукта, состав репозитория и текущие версии — в корневом [README.md](../README.md) (клиент и VPS-стек в одном дереве). Заметки линейки 0.5.247 — [CHANGELOG.md](../CHANGELOG.md).
...
| [android/README.md](../android/README.md) | Сборка клиента 0.5.247, keystore, GitHub Releases |
