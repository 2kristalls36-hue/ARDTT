...
Обзор продукта, состав репозитория и текущие версии — в корневом [README.md](../README.md) (клиент и VPS-стек в одном дереве). Заметки линейки 0.5.258 — [CHANGELOG.md](../CHANGELOG.md).
...
| [DEPLOY.md](DEPLOY.md) | Стек **1.0.46**: архив `ardtt-server-*-linux-<arch>.tar.gz`; Engine в `vendor/docker.tgz` |
...
| [android/README.md](../android/README.md) | Сборка клиента 0.5.258, keystore, GitHub Releases |
