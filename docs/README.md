...
Обзор продукта, состав репозитория и текущие версии — в корневом [README.md](../README.md) (клиент и VPS-стек в одном дереве). Заметки линейки 0.5.248 — [CHANGELOG.md](../CHANGELOG.md).
...
| [DEPLOY.md](DEPLOY.md) | Стек **1.0.38**: из приложения (GitHub) или `git clone` / `ARDTT_GIT_REF` |
...
| [android/README.md](../android/README.md) | Сборка клиента 0.5.248, keystore, GitHub Releases |
