...
Обзор продукта и текущие версии — в корневом [README.md](../README.md). Заметки линейки 0.5.221 — [CHANGELOG.md](../CHANGELOG.md).
...
| [DEPLOY.md](DEPLOY.md) | Установка стека **1.0.31** из приложения и Compose |
| [TELEMETRY.md](TELEMETRY.md) | Режим тестирования и формат логов |
| [android/README.md](../android/README.md) | Сборка клиента 0.5.221, keystore, GitHub Releases |
