...
Обзор продукта и текущие версии — в корневом [README.md](../README.md). Заметки линейки 0.5.237 — [CHANGELOG.md](../CHANGELOG.md).
...
| [android/README.md](../android/README.md) | Сборка клиента 0.5.237, keystore, GitHub Releases |
