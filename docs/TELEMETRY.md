...
Живое управление телефоном с облачного агента — отдельное приложение [LAB.md](LAB.md), ARDTT не перенастраивается. Запись после сессии — эта телеметрия. Обзор проверки на БС: [DEVICE-TEST.md](DEVICE-TEST.md).
