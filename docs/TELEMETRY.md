...
- Поле комментария можно заполнить заранее, без отправки файла, или зарегистрировать обращение кнопкой «Зарегистрировать без файла».
- Список сохранённых логов: имя файла, дата начала, длительность, размер.
- У каждой записи: **Отправить** и **Удалить**.
- Если комментарий уже заполнен, окно перед отправкой не показывается. Пустое поле по-прежнему спрашивается в диалоге.
