...
ARDTT для живой проверки **не перенастраивается**. Отдельный APK и SSH-контур — в приватном [2kristalls36-hue/ardtt-lab](https://github.com/2kristalls36-hue/ardtt-lab), не в этом дереве. APK собирает Actions того репозитория: [Releases](https://github.com/2kristalls36-hue/ardtt-lab/releases/latest). Зеркало на прыжке: `ssh://root@45.129.2.3/opt/repos/ardtt-lab.git`.
