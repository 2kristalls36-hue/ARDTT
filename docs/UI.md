...
Плашка вкладок — та же оболочка, без тени. Нажатие на вкладку на одну секунду двигает её иконку и возвращает в исходное положение: шестерёнка настроек поворачивается на 180° и обратно, без рывка в начале, на пике и в конце. `selectableGroup` + `Role.Tab`.
