...
Плашка вкладок — та же оболочка, без тени. Нажатие на вкладку на одну секунду двигает её иконку и возвращает в исходное положение: шестерёнка настроек поворачивается на 180° и обратно, ключ туннеля проворачивается на 360°, без рывка в начале и в конце. `selectableGroup` + `Role.Tab`.
