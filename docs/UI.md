...
Плашка вкладок — та же оболочка, без тени и без заливки выбранного пункта. Текущая вкладка отличается цветом иконки и подписи. Нажатие на вкладку на одну секунду двигает её иконку и возвращает в исходное положение: шестерёнка настроек поворачивается на 180° и обратно, ключ туннеля проворачивается на четверть оборота вокруг кончика лезвия, как в замке, и возвращается, без рывка в начале и в конце. `selectableGroup` + `Role.Tab`.
