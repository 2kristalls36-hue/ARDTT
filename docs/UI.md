...
размытием, цветной каймой и светлым краем. Заливка тонкая, чтобы преломление
было видно; оттенок кнопки не смешивается с оболочкой. Листы и диалоги остаются
непрозрачными, шапка растворяется только альфой, без размытия. До Android 13
заливка ровная, как раньше. Поиск обхода при открытой клавиатуре — непрозрачное
поле, без преломления.
