...
### Официальная лента ограничений (не API ТСПУ)

Публичного вебхука «белый список включён в регионе X» нет. ЦМУ ССОП / ТСПУ закрыты. Для приложения опрашиваем **официальные RSS**, которые сами входят в белый список и отвечают без ключа:

| Источник | URL | Зачем |
|----------|-----|--------|
| **ТАСС** | `https://tass.ru/rss/v2.xml` | гос. агентство, в БС |
| **РИА Новости** | `https://ria.ru/export/rss2/index.xml` | гос. агентство, в БС |
| **Интерфакс** | `https://www.interfax.ru/rss` | офиц. лента, обычно в БС |

Клиент тянет ленты с underlay (как probe), короткий таймаут, не чаще 15 мин (2 мин, если зонд уже подозревает БС). Парсер ищет ввод/снятие ограничений мобильного интернета, игнорирует новости про *состав* белого списка. Строка на экране Туннеля — подтверждение от агентства, **не** критерий Auto Direct/Bypass. Выбор пути по-прежнему: 77.88.8.8 vs 1.1.1.1 / 8.8.8.8.
