...
> APK **старше** этой линейки ждут `ardtt-stack-*.tar.gz` и запас с `main` — они **не** поставят 1.0.54. Нужен клиент 0.5.266. Provision API — Bearer; по умолчанию host bind `127.0.0.1:9100`.
