...
Продуктовое имя — **ARDTT**. Ранние черновики назывались иначе; в публичных текстах это имя больше не используется.  
Внутренние идентификаторы (`com.nonamevpn.app`, каталог `/opt/nonamevpn/` на VPS) оставлены для совместимости уже установленных клиентов и серверов.

Знак приложения — стилизованная монограмма **ARDTT**: белое **AR** над оранжевым **DTT** на тёмно-угольном скруглении.
...
- Иконка: белое **AR** над оранжевым **DTT** на тёмно-угольном поле (`#181E25`).
