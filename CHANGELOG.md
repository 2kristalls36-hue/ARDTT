...
- Дроны на экране туннеля — новые спрайты (фронт, ¾ и ближний ракурс). Фон прозрачный: исходные JPEG с шахматкой превращены в PNG с альфа-каналом, без клетки в пикселях.
