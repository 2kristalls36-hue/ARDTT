...
- Режим тестирования: комментарий заполняется на вкладке заранее; окно перед отправкой не показывается, если текст уже есть. Обращения получают номер и видны в истории.
